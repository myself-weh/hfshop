...
<div>
	...
	<table class="table">
		<tr>
			<td><input type="checkbox" id="ids" onclick="selAll($(this))"> id <button onclick="selReverse()">反选</button></td>
			<td>名称</td>
			<td>属性</td>
			<td>操作</td>
		</tr>
		...
		<tr>
			<td> <input type="checkbox" value="${spec.id}" name="id"  onclick="selOne()"> ${spec.id}</td>
			<td>${spec.specName}</td>
