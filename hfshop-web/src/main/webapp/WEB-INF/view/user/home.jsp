	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="sidebar-sticky pt-3">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link active"
							href="javascript:void(0)" toggle-data='./cartlist'> 购物 </a></li>
						<li class="nav-item"><a class="nav-link"
							href="javascript:void(0)" toggle-data='./orderlist?page=1'>
								订单 </a></li>
					...
					<h6
						...
						<span>报表</span> <a class="d-flex align-items-center text-muted"
					...
					<ul class="nav flex-column mb-2">
						<li class="nav-item"><a class="nav-link" href="#"> <svg
									...
									<polyline points="10 9 9 9 8 9"></polyline></svg> 当前月报
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									...
									<line x1="16" y1="13" x2="8" y2="13"></line>
									<line x1="16" y1="17" x2="8" y2="17"></line>
									<polyline points="10 9 9 9 8 9"></polyline></svg> 当前季报
						</a></li>
					</ul>
				</div>
			</nav>
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<div class="table-responsive" id="workContent">工作内容区域</div>
			</main>
		</div>
	</div>
	<nav
		class="navbar navbar-dark fixed-bottom bg-dark flex-md-nowrap p-0 shadow">
